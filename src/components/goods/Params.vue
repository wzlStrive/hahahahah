    ...
    <el-card>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick" type="card">
        ...
        <el-tab-pane label="动态参数" name="many">
          <!-- 添加参数按钮 -->
          <el-button type="primary" :disabled="isBtnDisbled" @click="addDialogVisible = true">添加参数</el-button>
          <!-- 动态参数列表区域 -->
        ...
        <el-tab-pane label="静态属性" name="only">
          <!-- 添加属性按钮 -->
          <el-button type="primary" :disabled="isBtnDisbled" @click="addDialogVisible = true">添加属性</el-button>
          <!-- 静态属性列表区域 -->
